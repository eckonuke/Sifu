...
void  AEnemyManager::CreateEnemy()
{
	...
	//적 위치,회전값 셋팅
	enemyArray[0]->SetActorLocation(spawnPoints[spawnindex]->GetActorLocation() + pos);
	enemyArray[0]->SetActorRotation(spawnPoints[spawnindex]->GetActorRotation());
	...
	//적 생성 및 배치하기
	//GetWorld()->SpawnActor<AHJ_Enemy>(enemyFactory, spawnPoints[index]->GetActorLocation(), FRotator(0));
